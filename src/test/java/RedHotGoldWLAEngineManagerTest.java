...
public class RedHotGoldWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(RedHotGoldWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/RedHotGoldWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/RedHotGoldWLAIW/InitOutcome.xml").getDocumentElement();
